...
data_train = CIFAR10(root="./datasets", download=True, train=True, transform=ToTensor())
data_test = CIFAR10(root="./datasets", download=True, train=False, transform=ToTensor())
...
#################################################################
# model = archi.FlexyConvAE(input_shape=(3, 32, 32), stride=1, kernel=3)
# loss_fn = nn.MSELoss()
...
#                 axes[0, j].set(title=class_names[y[j].item()], xlabel="original", ylabel="original")
